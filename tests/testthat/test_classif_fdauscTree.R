context("Rlearner_classif_fdausctree")

test_that("classif_fdausctree behaves like original api", {
  ...
  lrn = makeLearner("classif.fdausctree")
...
test_that("resampling fdausctree", {
  requirePackagesOrSkip("fda.usc", default.method = "load")
  lrn = makeLearner("classif.fdausctree")
