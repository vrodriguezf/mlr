#' @export
makeRLearner.classif.fdauscknn = function() {
  makeRLearnerClassif(
    cl = "classif.fdauscknn",
    package = "fda.usc",
    ...
    name = "fdauscknn",
    short.name = "fdauscknn",
    note = "Argument draw=FALSE is used as default."
  )
}

#' @export
trainLearner.classif.fdauscknn = function(.learner, .task, .subset, .weights = NULL, trim, draw, ...) {
...
#' @export
predictLearner.classif.fdauscknn = function(.learner, .model, .newdata, ...) {
