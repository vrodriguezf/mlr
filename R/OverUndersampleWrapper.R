...
#' @export
trainLearner.UndersampleWrapper = function(.learner, .task, .weights = NULL, usw.rate = 1, usw.cl = NULL, ...) {
...
#' @export
trainLearner.OversampleWrapper = function(.learner, .task, .weights = NULL, osw.rate = 1, osw.cl = NULL, ...) {
