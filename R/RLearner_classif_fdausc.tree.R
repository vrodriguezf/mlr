...
#'
#' @export
makeRLearner.classif.fdausc.tree = function() {
  makeRLearnerClassif(
    cl = "classif.fdausc.tree",
    package = "fda.usc",
    ...
    name = "fdausc.tree",
    short.name = "fdausc.tree"
  )
}

#' @export
trainLearner.classif.fdausc.tree = function(.learner, .task, .subset, .weights = NULL, ...) {
...
#' @export
predictLearner.classif.fdausc.tree = function(.learner, .model, .newdata, ...) {
