...
#'
#' @export
makeRLearner.classif.fdausc.depth = function() {
  makeRLearnerClassif(
    cl = "classif.fdausc.depth",
    package = "fda.usc",
    ...
    name = "fdausc.depth",
    short.name = "fdausc.depth"
  )
}

#' @export
trainLearner.classif.fdausc.depth = function(.learner, .task, .subset, .weights = NULL, par.depth, ...) {
...
#' @export
predictLearner.classif.fdausc.depth = function(.learner, .model, .newdata, ...) {
