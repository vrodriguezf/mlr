...
#'
#' @export
makeRLearner.classif.fdauscnp = function() {
  makeRLearnerClassif(
    cl = "classif.fdauscnp",
    package = "fda.usc",
...
#' @export
trainLearner.classif.fdauscnp = function(.learner, .task, .subset, .weights = NULL, trim, draw, ...) {
...
#' @export
predictLearner.classif.fdauscnp = function(.learner, .model, .newdata, ...) {
